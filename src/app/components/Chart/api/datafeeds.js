import {
  makeApiRequest, generateSymbol, parseFullSymbol,
} from './helpers'
// import {
...
export default {
  ...
  getBars: async (symbolInfo, resolution, from, to, onHistoryCallback, onErrorCallback, firstDataRequest) => {
    ...
    // const to = 1640850556
    console.log('[getBars]: Method call', symbolInfo, resolution, from, onHistoryCallback, onErrorCallback, firstDataRequest)
